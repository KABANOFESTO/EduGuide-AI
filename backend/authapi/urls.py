...
from .views import (
    ...
    AdminOnlyView,
    ReviewerOnlyView,
    AdminOrReviewerOrStaffOnlyView,
    ProfileUpdateView,
    ForgotPasswordView,
    ResetPasswordView,
...
urlpatterns = [
    ...
    path("reviewer-data/", ReviewerOnlyView.as_view(), name="reviewer-data"),
    path(
        "admin-or-reviewer-or-staff-data/",
        AdminOrReviewerOrStaffOnlyView.as_view(),
        name="admin-or-reviewer-or-staff-data",
    ),
